...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+X3uoMkIHhco1YTY1')
...
URL = "https://hkgjb.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://hkgjb.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://hkgjb.onrender.com/".format(FQDN)
else:
    URL = "https://hkgjb.onrender.com/".format(FQDN)
